...
- Backend run (needs Docker for MySQL on :3308): `cd backend && ./mvnw spring-boot:run` (→ http://localhost:8586)
...
- Frontend dev server: `cd frontend/angular-ecommerce && npm start` (→ http://localhost:4251)
